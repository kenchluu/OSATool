...
namespace OSATool
{
    public partial class Form_Global_Input2 : Form
    {
        ...
        public Form_Global_Input2()
        {
            InitializeComponent();
        }

        public Form_Global_Input2(String datatypeinput, String datastatusinput)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //this.groupBox1.Text = wb.Name;
            

            rangeindex = GetWBProperty(wb, datatype);
            if (rangeindex != null)
            {
        ...
        private void Bt_Update_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                if (String.IsNullOrEmpty(this.txt_Range.Text) == false)
                {
                    ...
                    SetWBProperty(wb, datatype, rangeindex);
                }
                else
                {
                    DelWBProperty(wb, datatype);
                }
            //}
