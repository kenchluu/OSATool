...
namespace OSATool
{
    public partial class Form_AssignWB : Form
    {
        ...
        static string columntypeWB = null;
        static string printMaxValue = null;

        public Form_AssignWB()
        {
            InitializeComponent();
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            rangeindex = GetProperty(ws, "rangeindexWB");
            columntypeWB = GetProperty(ws, "columntypeWB");
        ...
        private void Bt_Update_Click(object sender, EventArgs e)
        {
            ...
            if ((this.txtRange.Text != null) && (this.txtRange.Text != ""))
            {
                ...
                SetProperty(ws, "rangeindexWB", rangeindex);
            }
            else
            {
                DelProperty(ws, "rangeindexWB");
            }

            if (this.rB_DataCol.Checked == true)
            {
                SetProperty(ws, "columntypeWB", "TRUE");
            }
            else
            {
                DelProperty(ws, "columntypeWB");
            }
