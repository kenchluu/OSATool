...
namespace OSATool
{
    public partial class Form_MacroWB : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (macrolistnames.Count > 0)
            {
                ...
                Int32 kk = 1;
                while (GetWBProperty(wb, "macrobegin" + kk.ToString()) != null)
                {
                    string macroname = GetWBProperty(wb, "macrobegin" + kk.ToString());
                    //if (cbc_Macro.Items.Contains(macroname)) AddOutputRow_Macro1(macroname);
                    AddOutputRow_Macro1(macroname);
                    kk++;
                }
            }
            ...
            if (macrolistnames.Count > 0)
            {
                ...
                Int32 kk = 1;
                while (GetWBProperty(wb, "macroend" + kk.ToString()) != null)
                {
                    string macroname = GetWBProperty(wb, "macroend" + kk.ToString());
                    //if (cbc_Macro.Items.Contains(macroname)) AddOutputRow_Macro2(macroname);
                    AddOutputRow_Macro2(macroname);
                    kk++;
                }
            }
        ...
        {          
            ...
            Int32 jj = 1;
            while (GetWBProperty(wb, "macrobegin" + jj.ToString()) != null)
            {
                DelWBProperty(wb, "macrobegin" + jj.ToString());
                jj++;
            }
            ...
            if (this.dataGridView_Macro1.RowCount > 1)
            {
                for (Int32 kk = 0; kk < this.dataGridView_Macro1.RowCount; kk++)
                {
                    if (this.dataGridView_Macro1[0, kk].Value != null)
                    {
                        ...
                        {
                            SetWBProperty(wb, "macrobegin" + listcount.ToString(), this.dataGridView_Macro1[0, kk].Value.ToString());
            ...
            jj = 1;
            while (GetWBProperty(wb, "macroend" + jj.ToString()) != null)
            {
                DelWBProperty(wb, "macroend" + jj.ToString());
                jj++;
            }
            ...
            if (this.dataGridView_Macro2.RowCount > 1)
            {
                for (Int32 kk = 0; kk < this.dataGridView_Macro2.RowCount; kk++)
                {
                    if (this.dataGridView_Macro2[0, kk].Value != null)
                    {
                        ...
                        {
                            SetWBProperty(wb, "macroend" + listcount.ToString(), this.dataGridView_Macro2[0, kk].Value.ToString());
                            listcount = listcount + 1;
                        }
                    }
